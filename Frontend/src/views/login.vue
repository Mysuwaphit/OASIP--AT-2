...
<template>
    <div class="loginbox modal">
        ...
        <form>
            ...
            <!-- @focusout="validatePassword(yourPassword)" -->
            <input type="password" placeholder="Enter Password" :value="yourPassword" minlength="8" maxlength="14" @invalid="alert('Password cannot be null')" required>
