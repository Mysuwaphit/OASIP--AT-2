...
const goToUserDetails = (e) => appRouter.push({ name: 'UserDetail', params: { userId: e }})
...
<template>
    <div id="allEvent" class="scroll"  >
        <div id="eachEvent" v-for="(user, index) in users " :key="index">
          <div id="event" @click="goToUserDetails(user.id)">
              <span>
                    <p id="circle"></p> 
