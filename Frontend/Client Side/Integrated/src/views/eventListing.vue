...
const checkEmail = () => filterEvent.value = eventList.value.filter((e) => e.bookingEmail == yourEmail.value)
...
<template>
  <div class="app">
    ...
    <div id="event" v-if="eventList.length != 0">
        ...
        <p v-if="filterEvent.length === 0" id="no-scheduled">No Scheduled Events.</p>
    </div>
      <!-- List All Category-->
