...
const getEventList = async () => {
  const res = await fetch(`${import.meta.env.VITE_BASE_URL}/event/${params.eventId}`)
  if (res.status === 200) {
...
//   let a = eventListDetails.value.duration
//   let b = eventListDetails.value.eventCategory
//   a = b.duration
//   console.log(`b4 : ${a}`);
//   return getDuration.value = a
// }
